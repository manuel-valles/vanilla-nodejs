...
const { accountCreate, accountDeleted, accountEdit, checks, checksCreate, checksEdit, checksList, favicon, index, notFound, ping, public, sessionCreate, sessionDeleted, users, tokens } = require('./handlers');
