...
const { accountCreate, accountDeleted, accountEdit, checks, checksCreate, favicon, index, notFound, ping, public, sessionCreate, sessionDeleted, users, tokens } = require('./handlers');
